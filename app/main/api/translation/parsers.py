...
text_input_with_src_tgt.add_argument('prompt', type=str)
text_input_with_src_tgt.add_argument('terms', type=str)
...
text_input_with_src_tgt.add_argument('xmlTransform', type=str)
text_input_with_src_tgt.add_argument('forceSentenceLevel', type=inputs.boolean)
text_input_with_src_tgt.add_argument('maxSegmentTokens', type=int)
text_input_with_src_tgt.add_argument('split-newlines', type=inputs.boolean)
