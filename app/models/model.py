...
class Model(object):
    ...
    def translate(self, text, src=None, tgt=None, custom_prompt=None, split=True, replace_newlines=False):
        ...
        outputs = self.send_blocks_to_backend(blocks_of_text, src, tgt, custom_prompt=custom_prompt, replace_newlines=replace_newlines)
    ...
    def send_blocks_to_backend(self, blocks, src, tgt, custom_prompt=None, replace_newlines=False):
        """
        ...
        return self.send_sentences_to_backend(blocks, src, tgt, custom_prompt=custom_prompt, replace_newlines=replace_newlines)

    def send_sentences_to_backend(self, sentences, src, tgt, custom_prompt=None, replace_newlines=False):
